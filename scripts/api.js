...
function handleRequestWithRetry(requestFn, options, callbackData, callbacks) {
    try {
        ...
        sys.logs.info("[sendgrid] Handling request...: "+ JSON.stringify(error));
    }
}
...
exports.getAccessToken = function () {
    sys.logs.info("[sendgrid] Getting access token from oauth");
    return dependencies.oauth.functions.connectUser('sendgrid:userConnected');
}
...
exports.removeAccessToken = function () {
    sys.logs.info("[sendgrid] Removing access token from oauth");
    return dependencies.oauth.functions.disconnectUser('sendgrid:disconnectUser');
}
...
exports.get = function(path, httpOptions, callbackData, callbacks) {
    ...
    return httpService.get(SendGrid(options), callbackData, callbacks);
};
...
exports.post = function(path, httpOptions, callbackData, callbacks) {
    let options = checkHttpOptions(path, httpOptions);
    return httpService.post(SendGrid(options), callbackData, callbacks);
};
...
exports.put = function(path, httpOptions, callbackData, callbacks) {
    let options = checkHttpOptions(path, httpOptions);
    return httpService.put(SendGrid(options), callbackData, callbacks);
};
...
exports.options = function(path, httpOptions, callbackData, callbacks) {
    let options = checkHttpOptions(path, httpOptions);
    return httpService.options(SendGrid(options), callbackData, callbacks);
};
...
exports.utils = {
    ...
    getConfiguration: function (property) {
        if (!property) {
            sys.logs.debug('[sendgrid] Get configuration');
            return JSON.stringify(config.get());
        }
        sys.logs.debug('[sendgrid] Get property: '+property);
